          ...
          <>
            ...
            <div className="w-full flex items-center justify-between space-x-2">
              <button
                ...
                disabled={!qrBlob}
                className="flex-1 px-4 py-2 rounded-lg bg-yellow-600 text-white text-sm font-medium hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Télécharger QR Code
              </button>
              {!selectedClient.status_qrcode && (
                ...
                >
                  {activating ? "Activating..." : "Activer QR Code"}
                </button>
              )}
            </div>
          </>
